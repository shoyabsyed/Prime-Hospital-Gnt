...
function AboutTeam() {
    const doctorsTeam = [{
        ...
        details: ' CONSULTANT PHYSICIAN AND DIABETOLOGIST FELLOW IN INFECTIOUS DISEASE'
    },

    {
        name: ' Dr. J. TEJASWI - MD',
    ...
    {
        name: ' Dr. K. SAI RAJA SEKHAR ',
        designation: ' MBBS, MD RESPIRATORY MEDICINE',
    ...
    {
        name: ' Dr. B. PAVAN ',
        designation: ' M.S, M.CH (NIMS',
        img: '/Images/PavanImg.png',
        details: 'CONSULTANT NEUROSURGEON MINIMAL INVASIVE SPINE SURGERY (AHMEDABAD)'
    },
    ...
    return (
        <div>
            <section>
                <InnerBanner imagePath='Images/doctorImageBanner.png' heading='Doctors Team' />
            </section>
            <div className='flex flex-col w-full items-center'>
                <h2 className="py-4 text-center" style={{ color: ' #01AA5A', fontFamily: 'Tahoma', fontSize: '40px', fontWeight: '600' }}>Meet Our Doctors</h2>
                <div className='grid grid-cols-1 md:grid-cols-4 justify-center items-center gap-6'>
                    {
                        doctorsTeam.map((item) => {
                            console.log('items', item)
                            return (
                                <div className='w-48 grid grid-rows-3 text-center gap-2'>
